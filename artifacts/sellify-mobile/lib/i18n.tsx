...
const sv = {
  ...
  signUpHero: 'Skapa konto på Sellify',
  sessionExpired: 'Du behöver logga in för att fortsätta.',
  sessionCleared: 'En gammal session rensades. Försök logga in igen.',
  clearSession: 'Rensa session och logga in igen',
  oauthIncomplete: 'Inloggningen slutfördes inte. Försök igen.',
...
const en: typeof sv = {
  ...
  signUpHero: 'Create your Sellify account',
  sessionExpired: 'You need to sign in to continue.',
  sessionCleared: 'An old session was cleared. Please try signing in again.',
  clearSession: 'Clear session and sign in again',
  oauthIncomplete: 'Sign-in was not completed. Please try again.',
